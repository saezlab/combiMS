...
# pathDrugTargetsFinalv3_MR__with_some_additional_analysis__using_SIF_combiMS_PKN_No_Duplication_Activation_sign_PREPROCESSED.R



# pathDrugTargetsFinalv3_MR__using_Cluster_MR_Results_based_on_using_MIDAS_phosphos_processed__original_MB_JW__AND__combiMS_rerun_whole_pkn_preprocessed_MR_211117__gaBinaryT1_postCellNOptRupdate
# try by Marti
# try by Mel
...
data_used = "phosphos_processed"          # MR inserted
...
source("./calculateDefective_MR__with_Results_storage_name_Input.R")
