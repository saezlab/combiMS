...
OptCombiMS = function(fileName){
  ...
  Opt=gaBinaryT1(CNOlist=midas,model=model,initBstring=initBstring,stallGenMax=600,maxTime=10*60, maxGens=100000, verbose=FALSE,popSize=100,elitism=2)               
  ...
  Opt_results_list=list("patientName"=fileName2,"averageNw"=averageNw,"rmseAll"=rmseAll,"countInteractions"=countInteractions,"countNws"=dim(Opt$stringsTol)[1],"Opt"=Opt)   
